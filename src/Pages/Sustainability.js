...
function Sustainability() {
  ...
  return (
    <HomeLayout>
      ...
      <section className="lg:w-[80%] w-[90%] m-auto text-[#282828] text-base font-[350] tracking-tight flex flex-col lg:flex-row gap-5 p-5 ">
        <div className=" w-[80%] lg:w-1/2 h-60  lg:h-80 mx-4 lg:m-4 flex  lg:flex-row items-center">
          <img
            src="https://imaggeo.egu.eu/media/thumbs/previews/2021/03/17/15931.jpg.800x600_q85.jpg"
            alt="Card Image"
            className="w-1/2 h-full" />

          <div className=" bg-[#265d1b] h-full text-white lg:w-1/2 p-3">
