      ...
      <section className="border-t text-sm text-black lg:px-32  px-10">
        <div className="flex lg:justify-end">
          <div className="flex items-center gap-3 p-3">
            <img
              src="https://img.freepik.com/premium-vector/infographic-three-circle-diagram-linked-segments_91606-39.jpg"
              className="w-10"
            />
          ...
          <div className="flex items-center gap-3 p-3 px-5 border-l border-r">
            <img
              src="https://i.pinimg.com/564x/ea/fc/b7/eafcb70d4663faa713ba6d1af348cf9c.jpg"
              className="w-10"
            />
            <p>ITC Online App</p>
          </div>
          <div className="flex items-center gap-3 p-3">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyhAFmzVyC902J7gP5_Oz2H8_mbqFB0HTAJ7232pLYYqup73OZoXCE1sJ3KEUBNxqrAlw&usqp=CAU"
              className="w-10"
            />
      ...
      <div className="bg-[#3594e1] text-[#a2ceed] font-semibold hidden lg:block">
        <div className=" flex text-[11px] w-10/12 m-auto gap-10 px-10 py-14 ">
          <ul className="leading-6">
            <li className="text-white text-sm font-bold">ITC online</li>
            <li>Virginia House,</li>
            <li>37, J. L. Nehru Road</li>
            <li>Kolkata - 700071, India</li>
            <li className="text-bold text-white">Ph: +91 8981508645</li>
            <li>Working Hours:</li>
            <li>(Monday to Friday)</li>
            <li>- 9:00AM to 6:00PM</li>

            <li>Corporate Identity Number:</li>

            <li>For any queries or grievances,</li>
          </ul>
          ...
          <ul className="leading-6">
            <li className="text-white text-sm font-bold">Business</li>
            <li>Fast Moving Consumer</li>
            <li>Goods (FMCG)</li>
            <li>Hotels</li>
            <li>Paperboards &</li>
            <li>Speciality Papers</li>
            <li>Packaging</li>
            <li>Agri Business</li>
